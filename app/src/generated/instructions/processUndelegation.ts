...
export const PROCESS_UNDELEGATION_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([196, 28, 41, 206, 48, 37, 51, 167]);

export function getProcessUndelegationDiscriminatorBytes(): ReadonlyUint8Array {
...
export function getProcessUndelegationInstructionDataEncoder(): Encoder<ProcessUndelegationInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: PROCESS_UNDELEGATION_DISCRIMINATOR,
    }),
  );
}
